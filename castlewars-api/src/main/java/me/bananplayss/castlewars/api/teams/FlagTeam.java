...
public class FlagTeam extends AbstractTeam {
    ...
    public FlagTeam(String key, String prefix, String displayName, String color, VectorLocation spawn, BoundingBox boundingBox, Vector3i flagVector, BlockFace rotation, DyeColor baseColor, List<Pattern> patterns, ItemStack bannerItem) {
